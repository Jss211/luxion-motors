...
export function AboutUs() {
  ...
  return (
    <section id="nosotros" className="py-24 bg-black text-white relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold uppercase tracking-tight text-white mb-6 leading-tight flex flex-wrap gap-x-3 gap-y-2">
              Ingeniería Automotriz sin <Typewriter words={['Límites', 'Compromisos', 'Precedentes']} delayBetweenWords={2000} className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-[#B8860B] to-amber-400 block" />
            </h2>
